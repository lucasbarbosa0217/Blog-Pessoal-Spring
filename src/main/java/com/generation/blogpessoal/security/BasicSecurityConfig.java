...
public class BasicSecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests((auth) -> auth.requestMatchers("/usuarios/logar").permitAll()
				.requestMatchers("/usuarios/cadastrar").permitAll().requestMatchers("/usuarios/all").permitAll()
				.requestMatchers("/error/**").permitAll().requestMatchers(HttpMethod.GET, "/temas/**").permitAll()
				...
				.requestMatchers(HttpMethod.OPTIONS).permitAll().requestMatchers(HttpMethod.POST, "/roles")
				.hasRole("ADMIN").anyRequest().authenticated()).authenticationProvider(authenticationProvider())
